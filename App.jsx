...
export default function GuichetApp() {
  ...
  async function handleLogin(e) {
    ...
    // La correspondance téléphone → e-mail se fait désormais entièrement
    // côté serveur, dans l'Edge Function login-by-phone (avec la clé
    ...
    const profile = await fetchAgentProfile(data.user_id);
    setAuthLoading(false);
    if (!profile) {
