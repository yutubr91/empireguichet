...
const SUPPORT_BOT_KB = [
  {
    ...
    answer: "Bonjour 👋 Je suis l'assistant EmpireGuichet. Comment puis-je t'aider aujourd'hui ? Tu peux me poser une question sur l'inscription, l'abonnement, le KYC, une transaction, le parrainage, etc.",
  },
  {
    keywords: ["c'est quoi empireguichet", "c'est quoi empire guichet", "qu'est-ce que empireguichet", "presentation", "présentation", "comment ça marche", "comment ca marche"],
  ...
  {
    keywords: ["abonnement", "combien coute", "combien coûte", "prix", "tarif", "cout de l'abonnement", "coût de l'abonnement"],
  ...
  {
    keywords: ["abonnement expire", "abonnement expiré", "renouveler", "renouvellement", "compte bloque abonnement", "compte bloqué abonnement"],
  ...
  },
  {
    ...
    answer: "Pour t'inscrire : renseigne ton nom, ton numéro de téléphone, une adresse Gmail et crée ton code PIN. Tu recevras un code de confirmation par e-mail. Ensuite, complète ta vérification KYC pour activer pleinement ton compte.",
  },
  {
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{ opacity: 0.7, color: msg.sender === "user" ? "#052E36" : COLORS.textMuted }}
              >
                {msg.time}
              </div>
            </div>
