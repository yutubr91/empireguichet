...
const NETWORKS = [
  { id: "mtn", name: "MTN MoMo", color: "#FFCC00", fg: "#1A1400", fee: 0.012, letter: "MTN" },
  { id: "orange", name: "Orange Money", color: "#FF6600", fg: "#2A0E00", fee: 0.012, letter: "OM" },
  { id: "moov", name: "Moov Money", color: "#0B3FA8", fg: "#F3F0E8", fee: 0.01, letter: "MV" },
  { id: "wave", name: "Wave", color: "#1DC8F2", fg: "#00222C", fee: 0.008, letter: "W" },
  { id: "djamo", name: "Djamo", color: "#7B5CFA", fg: "#F3F0E8", fee: 0.015, letter: "DJ" },
  { id: "crypto", name: "Crypto (USDT)", color: "#2BBF8A", fg: "#08221A", fee: 0.02, letter: "₮" },
];
...
function NetworkBadge({ net, size = 40 }) {
  return (
    <div
      style={{
        width: size,
...
export default function GuichetApp() {
  ...
  function handleSubmit(e) {
    ...
    if (net.id !== "crypto" && phone.replace(/\D/g, "").length < 8) {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ background: "rgba(15,16,36,0.92)" }}>
      ...
      <section className="max-w-6xl mx-auto px-5 pt-14 pb-16 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p className="text-base leading-relaxed mb-8" style={{ color: COLORS.textMuted, maxWidth: 440 }}>
            MTN, Orange, Moov, Wave, Djamo et crypto — vos agents traitent chaque
      ...
      <section id="reseaux" className="max-w-6xl mx-auto px-5 py-14" style={{ borderTop: `1px solid ${COLORS.surfaceLine}` }}>
        <h2 className="gc-display text-2xl font-semibold mb-2">Réseaux pris en charge</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6 gc-fade-in">
            ...
            >
              ...
              <label className="text-xs mb-2 block" style={{ color: COLORS.textMuted }}>
                Numéro {net.id === "crypto" ? "/ adresse" : "de téléphone"}
              </label>
              <input
                value={phone}
                onChange={(e) => setPhone(e.target.value)}
                placeholder={net.id === "crypto" ? "T... adresse USDT" : "07 XX XX XX XX"}
